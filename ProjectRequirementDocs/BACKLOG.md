...
33. **[PRIORITY, FIX NOW] Migrate from legacy UI.Text to TextMeshPro.** Confirmed still visibly blurry even at full screen size, not just small Editor test windows, ruling out the "will be fine at native device resolution" hope. Legacy UI.Text has no mipmap chain for its dynamic font atlas, causing visible softness. No longer optional or deferred, this is the next task to fix across all screens (Main Menu, Settings, Gameplay HUD, Level Complete/Failed, Pause) before any further new feature work continues.
